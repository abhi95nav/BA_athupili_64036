...
```{r}
churndata_df <- read.csv("Churn_Train.csv",       
na.strings = c("", "NA"))
...
#NA refers to missing values. 16 out of of the 20 variables (columns) have NA values. It can be observed that 10 variables have about 200 ‘NA’ values while 2 have 301 and 1 has 501.
